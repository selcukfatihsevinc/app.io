...
Schema.prototype.getFunc = function (obj, self, cb) {
    ...
    if( ! self._methodMaster && self._owner && dot.get(self._owner, 'protect.get') && self._res.apiResponse)
...
Schema.prototype.getById = function (id, cb) {
    ...
    // set acl owner protection (api response ise owner protection uygula)
    if( ! this._methodMaster && this._owner && dot.get(this._owner, 'protect.getid') && this._res.apiResponse)
...
Schema.prototype.post = function (obj, cb) {
    ...
    // set acl owner protection (api response ise owner protection uygula)
    if( ! this._methodMaster && this._owner && dot.get(this._owner, 'protect.post') && this._res.apiResponse)
...
Schema.prototype.put = function (id, obj, cb) {
    ...
    // set acl owner protection (api response ise owner protection uygula)
    if( ! this._methodMaster && this._owner && dot.get(this._owner, 'protect.put') && this._res.apiResponse) {
        if(where)
    ...
    async.waterfall(a, function(err, parsed, doc) {
        ...
        // set acl owner protection (api response ise owner protection uygula)
        if( ! self._methodMaster && self._owner && dot.get(self._owner, 'protect.put') && self._res.apiResponse) {
